            ...
            (res) => {
                ...
                while (res["comptes"][i] != null) {
                    ...
                    switch(this.compte.type)
                    {
                        ...
                        case 0: this.compte.balance = res["comptes"][i]["Balance"]+" DZD";
                        break;
                        case 1:this.compte.balance = res["comptes"][i]["Balance"]+" DZD";
                        break;
                        case 2:this.compte.balance = res["comptes"][i]["Balance"]+" EUR";
                        break;
                        case 3:this.compte.balance = res["comptes"][i]["Balance"]+" USD";
                        break;
                    }
